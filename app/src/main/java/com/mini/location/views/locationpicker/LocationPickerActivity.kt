package com.mini.location.views.locationpicker

import com.mini.location.views.base.BaseActivity
import com.mini.location.views.history.HistoryActivity
...
import com.mini.location.repositories.DataBaseHistoryLocation
import com.mini.location.views.theme.locationTheme
import com.mini.location.service.ServiceGoRoot
import com.mini.location.service.ServiceGoNoroot
import com.mini.location.utils.GoUtils
import com.mini.location.utils.MapUtils
import com.mini.location.utils.ShareUtils
import com.mini.location.R
import com.mini.location.viewmodels.LocationPickerViewModel
import com.mini.location.views.locationsimulation.LocationSimulationActivity
...
class LocationPickerActivity : BaseActivity(), SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        MiniLog.i(this, "LocationPickerActivity", "MainActivity: onCreate")
        ...
        try {
            ...
            MiniLog.e(this, "LocationPickerActivity", "Error initializing MapView: ${e.message}")
                ...
                LocationPickerScreen(
                    ...
                    onNavigate = { id ->
                        when(id) {
                            ...
                            R.id.nav_navigation_simulation -> startActivity(Intent(this, com.mini.location.views.navigationsimulation.NavigationSimulationActivity::class.java))
                            R.id.nav_settings -> startActivity(Intent(this, SettingsActivity::class.java))

                            R.id.nav_sponsor -> startActivity(Intent(this, com.mini.location.views.sponsor.SponsorActivity::class.java))
                            R.id.nav_dev -> {
                                try {
    ...
    */
    ...
    private fun doGoLocation() {
        MiniLog.i(this, "LocationPickerActivity", "doGoLocation called")
        ...
        if (runMode != LocationPickerViewModel.RUN_MODE_ROOT) {
            if (!GoUtils.isAllowMockLocation(this)) {
                MiniLog.i(this, "LocationPickerActivity", "Mock location permission NOT granted")
            ...
            if (!isGpsEnable) {
                MiniLog.i(this, "LocationPickerActivity", "GPS NOT enabled")
        ...
        if (isMockServStart) {
            MiniLog.i(this, "LocationPickerActivity", "Stopping Mock Service...")
            ...
            try {
                ...
                MiniLog.e(this, "LocationPickerActivity", "Error unbinding service: ${e.message}")
            }
            stopService(intent)
            isMockServStart = false
        } else {
            MiniLog.i(this, "LocationPickerActivity", "Starting Mock Service...")
            val serviceClass = if (runMode == "root") ServiceGoRoot::class.java else ServiceGoNoroot::class.java
            val intent = Intent(this, serviceClass)
            ...
            MiniLog.i(this, "LocationPickerActivity", "Putting extras: lat=${mMarkLatLngMap.latitude}, lng=${mMarkLatLngMap.longitude}, type=BD09, runMode=$runMode, joystick=$joystickEnabled")
    ...
    private fun initLocationDataBase() {
        try {
            ...
            MiniLog.e(this, "LocationPickerActivity", "ERROR - initLocationDataBase: ${e.message}")
        }
    }
