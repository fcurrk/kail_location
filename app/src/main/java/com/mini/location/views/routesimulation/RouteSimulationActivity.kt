...
class RouteSimulationActivity : BaseActivity(), SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initMapLocation()
        MiniLog.i(this, "RouteSimulationActivity", "Map and location initialized")
                ...
                val onNavigate: (Int) -> Unit = { id ->
                    when (id) {
                        ...
                        R.id.nav_nfc_simulation -> {
                            startActivity(Intent(this@RouteSimulationActivity, com.mini.location.views.nfcsimulation.NfcSimulationActivity::class.java))
                        }
                        R.id.nav_settings -> {
                            startActivity(Intent(this@RouteSimulationActivity, SettingsActivity::class.java))
                        }
                        R.id.nav_sponsor -> {
                            startActivity(Intent(this@RouteSimulationActivity, com.mini.location.views.sponsor.SponsorActivity::class.java))
                        }
                        R.id.nav_contact -> {
                            try {
                        ...
                        RoutePlanScreen(
                            ...
                            onLocateClick = {
                                ...
                                if (!invalid) {
                                    ...
                                    MiniLog.i(this@RouteSimulationActivity, "RouteSimulationActivity", "Animate to current $ll")
                                } else {
                                    MiniLog.w(this@RouteSimulationActivity, "RouteSimulationActivity", "Current location unavailable")
                                }
                            },
                            currentLatLng = run {
                                val lat = mCurrentLat
