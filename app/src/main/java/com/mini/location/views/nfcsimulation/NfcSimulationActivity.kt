...
import com.mini.location.views.nfcsimulation.NfcSimulationContract.NavigateDestination
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onNavigate = { navId ->
            val intent = when (navId) {
                R.id.nav_location_simulation -> Intent(this, com.mini.location.views.locationsimulation.LocationSimulationActivity::class.java)
                R.id.nav_route_simulation -> Intent(this, com.mini.location.views.routesimulation.RouteSimulationActivity::class.java)
                R.id.nav_settings -> Intent(this, com.mini.location.views.settings.SettingsActivity::class.java)
                R.id.nav_navigation_simulation -> Intent(this, com.mini.location.views.navigationsimulation.NavigationSimulationActivity::class.java)
                R.id.nav_nfc_simulation -> null
                R.id.nav_sponsor -> Intent(this, com.mini.location.views.sponsor.SponsorActivity::class.java)
                else -> null
            }
