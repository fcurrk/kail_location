package com.mini.location.views.joystick
            ...
            if (mapView != null) {
                JoyStickMapOverlay(
                    ...
                    onSelectSearchResult = { item ->
                        val lat = item[com.mini.location.viewmodels.LocationPickerViewModel.POI_LATITUDE].toString().toDouble()
                        val lng = item[com.mini.location.viewmodels.LocationPickerViewModel.POI_LONGITUDE].toString().toDouble()
