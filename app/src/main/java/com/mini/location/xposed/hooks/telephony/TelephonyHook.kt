package com.mini.location.xposed.hooks.telephony
...
import com.mini.location.xposed.utils.hookBefore
import com.mini.location.xposed.utils.hookMethodBefore
import com.mini.location.xposed.utils.onceHookDoNothingMethod
...
object TelephonyHook: BaseTelephonyHook() {
    operator fun invoke(classLoader: ClassLoader) {
        if(!initDivineService("TelephonyHook")) {
            MiniLog.e(null, "Mini_Xposed", "Failed to init mock service in TelephonyHook")
            return
        }
...
//        }
        ...
        val hookGetPhoneTyp = beforeHook {
            if (FakeLoc.enable && !BinderUtils.isSystemAppsCall()) {
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "getActivePhoneType: injected!")
                }
        ...
        if(cPhoneInterfaceManager.hookAllMethods("getActivePhoneType", hookGetPhoneTyp).isEmpty()) {
            MiniLog.e(null, "Mini_Xposed", "Hook PhoneInterfaceManager.getActivePhoneType failed")
        }
        if(cPhoneInterfaceManager.hookAllMethods("getActivePhoneTypeForSlot", hookGetPhoneTyp).isEmpty()) {
            MiniLog.w(null, "Mini_Xposed", "Hook PhoneInterfaceManager.getActivePhoneTypeForSlot failed")
        }

        cPhoneInterfaceManager.declaredMethods.find { it.name == "getAllCellInfo" }?.let {
            val hookGetAllCellInfo = afterHook {
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "getAllCellInfo: injected! caller = ${BinderUtils.getCallerUid()}")
                }
            ...
            if (XposedBridge.hookMethod(it, hookGetAllCellInfo) == null) {
                MiniLog.e(null, "Mini_Xposed", "Hook PhoneInterfaceManager.getAllCellInfo failed")
            }
        }
        ...
        if(XposedBridge.hookAllMethods(cPhoneInterfaceManager, "getCellLocation", afterHook {
                ...
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "${method.name}: injected!")
                }
            ...
            MiniLog.e(null, "Mini_Xposed", "Hook PhoneInterfaceManager.getCellLocation failed")
        }

        beforeHook {
            if (FakeLoc.enable && !BinderUtils.isSystemAppsCall()) {
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "getDataNetworkType: injected!")
                }
                result = 4
            }
        }.let {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            if (cPhoneInterfaceManager.hookAllMethods("getNeighboringCellInfo", beforeHook {
                ...
                MiniLog.e(null, "Mini_Xposed", "Hook PhoneInterfaceManager.getNeighboringCellInfo failed")
            }
        }
        ...
        if (cTelephonyRegistry == null) {
            MiniLog.e(null, "Mini_Xposed", "TelephonyRegistry not found")
        } else {
    ...
    fun hookTelephonyRegistry(cTelephonyRegistry: Class<*>) {
        cTelephonyRegistry.declaredMethods.filter { (it.name == "listen" || it.name == "listenWithEventList") && !Modifier.isAbstract(it.modifiers) }
            .map {
                ...
                val (m, idx) = it
                if (idx == -1) {
                    MiniLog.e(null, "Mini_Xposed", "IPhoneStateListener not found")
                    return@forEach
                }
                m.hookBefore {
                    if (!FakeLoc.enable || BinderUtils.isSystemAppsCall()) {
                    ...
                    if (!hasHookOnCellLocationChanged) {
                        MiniLog.e(null, "Mini_Xposed", "Hook onCellLocationChanged failed")
                    }
        ...
        cTelephonyRegistry.hookMethodBefore("notifyCellInfo", List::class.java) {
            ...
            if (FakeLoc.enableDebugLog) {
                MiniLog.d(null, "Mini_Xposed", "notifyCellInfo: injected!")
            }
        ...
        cTelephonyRegistry.hookMethodBefore("notifyCellInfoForSubscriber", Int::class.java, List::class.java) {
            ...
            if (FakeLoc.enableDebugLog) {
                MiniLog.d(null, "Mini_Xposed", "notifyCellInfoForSubscriber: injected!")
            }
        ...
        cTelephonyRegistry.hookMethodBefore("notifyCellLocation", Bundle::class.java) {
            ...
            if (FakeLoc.enableDebugLog) {
                MiniLog.d(null, "Mini_Xposed", "notifyCellLocation: injected!")
            }
        ...
        cTelephonyRegistry.hookMethodBefore("notifyCellLocationForSubscriber", Int::class.java, Bundle::class.java) {
            ...
            if (FakeLoc.enableDebugLog) {
                MiniLog.d(null, "Mini_Xposed", "notifyCellLocationForSubscriber: injected!")
            }
    ...
    fun hookSubOnTransact(classLoader: ClassLoader) {
        ...
        if (cISub == null) {
            MiniLog.e(null, "Mini_Xposed", "ISub.Stub not found")
            return
        }
...
//                }
        ...
        if(cISub.hookAllMethods("onTransact", hookOnTransact).isEmpty()) {
            MiniLog.e(null, "Mini_Xposed", "Hook ISub.Stub.onTransact failed")
        }
    }
