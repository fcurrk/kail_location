...
package com.mini.location.xposed.hooks.wlan
    ...
    operator fun invoke(classLoader: ClassLoader) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            if (cSystemServerClassLoaderFactory == null) {
                MiniLog.w(null, "Mini_Xposed", "Failed to find SystemServerClassLoaderFactory")
                return
            }
            ...
            if (wifiClassLoader == null) {
                MiniLog.w(null, "Mini_Xposed", "Failed to find wifiClassLoader")
                return
            }
            val wifiClazz = "com.android.server.wifi.WifiServiceImpl".toClass(wifiClassLoader)
            if (wifiClazz == null) {
                MiniLog.w(null, "Mini_Xposed", "Failed to find WifiServiceImpl class")
                return
            }
            ...
            if (cSystemServiceManager == null) {
                MiniLog.w(null, "Mini_Xposed", "Failed to find SystemServiceManager")
                return
            }
            cSystemServiceManager.hookAllMethods("loadClassFromLoader", afterHook {
                if (args[0] == "com.android.server.wifi.WifiService") {
                    kotlin.runCatching {
                        ...
                        MiniLog.e(null, "Mini_Xposed", "Failed to hook WifiService: ${it.message}")
                    }
                }
            })
        }
    ...
    private fun hookWifiServiceImpl(wifiClazz: Class<*>) {
        ...
        wifiClazz.hookAllMethods("getConnectionInfo", beforeHook {
            ...
            if (FakeLoc.enableDebugLog)
                MiniLog.d(null, "Mini_Xposed", "In getConnectionInfo with caller: $packageName, state: ${FakeLoc.enableMockWifi}")
        ...
        wifiClazz.hookAllMethods("getScanResults", afterHook {
            ...
            if (FakeLoc.enableDebugLog)
                MiniLog.d(null, "Mini_Xposed", "In getScanResults with caller: $packageName, state: ${FakeLoc.enableMockWifi}")
            ...
            if(FakeLoc.enableMockWifi) {
                ...
                if (resultClass.name.contains("ParceledListSlice")) runCatching {
                    ...
                    MiniLog.e(null, "Mini_Xposed", "getScanResults: ParceledListSlice failed: ${it.message}")
                }

                if (FakeLoc.enableDebugLog) {
                    MiniLog.e(null, "Mini_Xposed", "getScanResults: Unknown return type: ${result?.javaClass?.name}")
                }
            }
        })
    }
