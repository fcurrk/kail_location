...
import com.mini.location.nmea.NMEA
import com.mini.location.nmea.NmeaValue
...
abstract class BaseLocationHook: BaseDivineService() {
    ...
    fun injectLocation(originLocation: Location, realLocation: Boolean = true): Location {
        ...
        if (FakeLoc.hideMock) {
            ...
            location.extras?.putBoolean("mini.enable", true)
        ...
        kotlin.runCatching {
            ...
            MiniLog.e(null, "Mini_Xposed", "makeComplete failed: ${it.message}")
        }

        if (FakeLoc.enableDebugLog) {
            MiniLog.d(null, "Mini_Xposed", "injectLocation success! $location")
        }
    ...
    fun injectNMEA(nmeaStr: String): String? {
        ...
        kotlin.runCatching {
            ...
            MiniLog.e(null, "Mini_Xposed", "NMEA parse failed: ${it.message}, source = $nmeaStr")
            return null
        }
        return null
    }
