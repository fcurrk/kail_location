package com.mini.location.xposed.hooks.provider
...
import com.mini.location.xposed.hooks.BasicLocationHook.injectLocation
...
import com.mini.location.xposed.utils.diyHook
import com.mini.location.xposed.utils.hook
import com.mini.location.xposed.utils.onceHook
...
object LocationProviderManagerHook {
    private val hookOnFetchLocationResult = beforeHook {
        ...
        if (FakeLoc.enableDebugLog) {
            MiniLog.d(null, "Mini_Xposed", "${method}: injected!")
        }
        ...
        if (mLocationsField == null) {
            MiniLog.e(null, "Mini_Xposed", "Failed to find mLocations in LocationResult")
            return@beforeHook
        }
        ...
        run {
            ...
            XposedBridge.hookAllConstructors(cInternalState, object: XC_MethodHook() {
                override fun beforeHookedMethod(param: MethodHookParam) {
                    ...
                    if (FakeLoc.enableDebugLog) {
                        MiniLog.d(null, "Mini_Xposed", "AbstractLocationProvider.InternalState: injected!")
                    }
    ...
    private fun hookDelegateLocationProvider(classLoader: ClassLoader) {
        ...
        waitForInitialization.diyHook(
            ...
            before = {
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "DelegateLocationProvider.waitForInitialization: injected!")
                }
    ...
    private fun hookLocationProviderManager(classLoader: ClassLoader) {
        ...
        XposedBridge.hookAllMethods(cLocationProviderManager, "setRealProvider", object: XC_MethodHook() {
            override fun beforeHookedMethod(param: MethodHookParam) {
                ...
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "setRealProvider: $locationProvider")
                }
            }
        })
        XposedBridge.hookAllMethods(cLocationProviderManager, "setMockProvider", object: XC_MethodHook() {
            override fun beforeHookedMethod(param: MethodHookParam) {
                val locationProvider = param.args[0]
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "setMockProvider: $locationProvider")
                }
            }
        })
        XposedBridge.hookAllMethods(cLocationProviderManager, "sendExtraCommand", object: XC_MethodHook() {
            override fun beforeHookedMethod(param: MethodHookParam) {
                ...
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "sendExtraCommand: $command, $extras")
                }
            }
        })
        ...
        run {
            ...
            if(cLocationProviderManager.onceHookAllMethod("getCurrentLocation", object: XC_MethodHook() {
                override fun beforeHookedMethod(param: MethodHookParam) {
                    ...
                    if (FakeLoc.enableDebugLog) {
                        MiniLog.d(null, "Mini_Xposed", "getCurrentLocation injected: $callback")
                    }
                    ...
                    if (XposedBridge.hookAllMethods(classCallback, "onLocation", object: XC_MethodHook() {
                        override fun beforeHookedMethod(param: MethodHookParam?) {
                            ...
                            if (FakeLoc.enableDebugLog)
                                MiniLog.d(null, "Mini_Xposed", "onLocation(LocationProviderManager.getCurrentLocation): injected!")
                            param.args[0] = injectLocation(location)
                        }
                    }).isEmpty()) {
                        MiniLog.e(null, "Mini_Xposed", "hook onLocation(LocationProviderManager.getCurrentLocation) failed")
                    }

                    hookedListeners.add(classCallback.name)
                }
            }).isEmpty()) {
                MiniLog.e(null, "Mini_Xposed", "hook LocationProviderManager.getCurrentLocation failed")
            }
        }
        ...
        cLocationProviderManager.onceHookMethodBefore("onReportLocation") {
            ...
            if (fieldMRegistrations == null) {
                MiniLog.e(null, "Mini_Xposed", "Failed to find mRegistrations in LocationProviderManager")
            ...
            if (FakeLoc.enableDebugLog) {
                MiniLog.d(null, "Mini_Xposed", "onReportLocation: injected!")
            }
    ...
    private fun hookOtherProvider(classLoader: ClassLoader) {
        kotlin.runCatching {
            ...
            if(BlindHookLocation(cGnssLocationProvider, classLoader) == 0) {
                cGnssLocationProvider.onceHookMethodBefore("reportLocation", Location::class.java) {
                    ...
                    if (FakeLoc.enableDebugLog) {
                        MiniLog.d(null, "Mini_Xposed", "LocationProviderBase.reportLocation: injected!")
                    }
            ...
            cGnssLocationProvider.onceHookMethodBefore("reportLocations", List::class.java) {
                if (!FakeLoc.enable) return@onceHookMethodBefore
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "LocationProviderBase.reportLocations: injected!")
                }
            ...
            MiniLog.w(null, "Mini_Xposed", "Failed to hook LocationProviderBase: ${it.message}")
        }
        ...
        kotlin.runCatching {
            ...
            cGnssLocationProvider.onceHookMethodBefore("onReportLocation", Boolean::class.java, Location::class.java) {
                ...
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "GnssLocationProvider.onReportLocation: injected! ${args[1]}")
                }
            }
            ...
            cGnssLocationProvider.onceHookMethodBefore("onReportLocations", Boolean::class.java, Array<Location>::class.java) {
                ...
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "GnssLocationProvider.onReportLocations: injected! ${args[0]}")
                }
            }
            ...
            cGnssLocationProvider.onceHookMethodBefore("getCellType", CellInfo::class.java) {
                if (!FakeLoc.enable) return@onceHookMethodBefore
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "GnssLocationProvider.getCellType: injected!")
                }
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                cGnssLocationProvider.onceHookMethodBefore("getCidFromCellIdentity", CellIdentity::class.java) {
                    if (!FakeLoc.enable) return@onceHookMethodBefore
                    if (FakeLoc.enableDebugLog) {
                        MiniLog.d(null, "Mini_Xposed", "GnssLocationProvider.getCidFromCellIdentity: injected!")
                    }
                ...
                cGnssLocationProvider.onceHookMethodBefore("setRefLocation", Int::class.java, CellIdentity::class.java) {
                    if (!FakeLoc.enable) return@onceHookMethodBefore
                    if (FakeLoc.enableDebugLog) {
                        MiniLog.d(null, "Mini_Xposed", "GnssLocationProvider.setRefLocation: injected!")
                    }
            ...
            MiniLog.w(null, "Mini_Xposed", "Failed to hook GnssLocationProvider: ${it.message}")
        }
    }
}