package com.mini.location.xposed.hooks.thirdparty
    ...
    private fun hookAMapNetworkLocationManager(classLoader: ClassLoader) {
        ...
        XposedBridge.hookAllMethods(cNetworkLocationManager, "onSendExtraCommand", object : XC_MethodHook() {
            override fun beforeHookedMethod(param: MethodHookParam?) {
                ...
                MiniLog.d(null, "XPOSED", "高德 onSendExtraCommand 命令=$cmd 附加=$extras", isHighFrequency = true)
                param.result = false
            }
        })
        ...
        XposedBridge.hookAllMethods(cLocationClient, "requestNLPNormal", object : XC_MethodHook() {
            override fun afterHookedMethod(param: MethodHookParam?) {
                ...
                kotlin.runCatching {
                    ...
                    MiniLog.d(null, "XPOSED", "百度 requestNLPNormal 注入位置 纬度=${loc.latitude} 经度=${loc.longitude}", isHighFrequency = true)
                }
            }
        })
