...
import com.mini.location.xposed.utils.hookAllMethodsAfter
import com.mini.location.xposed.utils.hookAllMethodsBefore
import com.mini.location.xposed.utils.toClass
import com.mini.location.xposed.utils.toClassOrThrow
...
//        XposedHelpers.findAndHookMethod("android.location.Location", classLoader, "setLongitude", Double::class.java, hookSetLongitude)
        ...
        kotlin.runCatching {
           ...
           MiniLog.e(null, "Mini_Xposed", "Failed to hook LocationResult: ${it.message}")
        }
