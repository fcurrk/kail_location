...
import com.mini.location.xposed.core.KailCommandHandler
...
import com.mini.location.xposed.utils.afterHook
import com.mini.location.xposed.utils.beforeHook
import com.mini.location.xposed.utils.hookAllMethods
...
private fun buildGnssStatusObject(mockGps: MockGnssData): Any? {
    return runCatching {
        ...
        if (constructor == null) {
            MiniLog.e(null, "Mini_Xposed", "GnssStatus constructor not found")
            return null
        }
        ...
        MiniLog.e(null, "Mini_Xposed", "buildGnssStatusObject failed: ${it.message}")
    }.getOrNull()
}
...
private fun pushMockGnssToListener(listener: Any) {
    ...
    for (m in methods) {
        ...
        if (FakeLoc.enableDebugLog) {
            MiniLog.d(null, "Mini_Xposed", "Pushed GNSS status to ${listener.javaClass.name} via ${m.name}(${m.parameterTypes.size} args)")
        }
        break
    }
}
    ...
    override fun run() {
        ...
        for (listener in listeners) {
            runCatching {
                ...
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "Removed dead GNSS listener: ${it.message}")
                }
            }
        }
...
internal object LocationServiceHook: BaseLocationHook() {
    ...
    fun onService(cILocationManager: Class<*>) {
        ...
        if (FakeLoc.enableDebugLog) {
            MiniLog.d(null, "Mini_Xposed", "ILocationManager.Stub: class = $cILocationManager")
        }
        ...
        if(cILocationManager.hookAllMethods("getLastLocation", afterHook {
                ...
                if(FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "getLastLocation: injected! $result")
                }
        }).isEmpty()) {
            MiniLog.e(null, "Mini_Xposed", "hook getLastLocation failed")
        }
        ...
        cILocationManager.hookAllMethods("requestLocationUpdates", beforeHook {
            ...
            val listener = args.filterIsInstance<IInterface>().firstOrNull() ?: run {
                MiniLog.e(null, "Mini_Xposed", "requestLocationUpdates: listener is null: $method")
                return@beforeHook
            }

            if(FakeLoc.enableDebugLog) {
                MiniLog.d(null, "Mini_Xposed", "requestLocationUpdates: injected! $listener")
            }
        ...
        cILocationManager.hookAllMethods("removeUpdates", afterHook {
            val listener = args.filterIsInstance<IInterface>().firstOrNull() ?: run {
                MiniLog.e(null, "Mini_Xposed", "removeUpdates: listener is null: $method")
                return@afterHook
            }
            if(FakeLoc.enableDebugLog) {
                MiniLog.d(null, "Mini_Xposed", "removeUpdates: injected! $listener")
            }
        ...
        cILocationManager.hookAllMethods("registerLocationListener", beforeHook {
            ...
            val listener = args.filterIsInstance<IInterface>().firstOrNull() ?: run {
                MiniLog.e(null, "Mini_Xposed", "registerLocationListener: listener is null: $method")
                return@beforeHook
            }

            if(FakeLoc.enableDebugLog) {
                MiniLog.d(null, "Mini_Xposed", "registerLocationListener: injected! $listener, from ${BinderUtils.getUidPackageNames()}")
            }
        ...
        cILocationManager.hookAllMethods("unregisterLocationListener", afterHook {
            val listener = args.filterIsInstance<IInterface>().firstOrNull() ?: run {
                MiniLog.e(null, "Mini_Xposed", "unregisterLocationListener: listener is null: $method")
                return@afterHook
            }
            if(FakeLoc.enableDebugLog) {
                MiniLog.d(null, "Mini_Xposed", "unregisterLocationListener: injected! $listener")
            }
        ...
        run {
            cILocationManager.hookAllMethods("addGnssBatchingCallback", beforeHook {
                ...
                if(FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "addGnssBatchingCallback: injected!")
                }
                ...
                classCallback.onceHookAllMethod("onLocationBatch", beforeHook onLocationBatch@ {
                    ...
                    if (FakeLoc.enableDebugLog) {
                        MiniLog.d(null, "Mini_Xposed", "onLocationBatch: injected!")
                    }
        ...
        cILocationManager.hookAllMethods("requestGeofence", beforeHook {
            if (FakeLoc.disableRequestGeofence && !FakeLoc.enableAGPS) {
                if(FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "requestGeofence: injected!")
                }
                result = null
            }
        })
...
//        })
        ...
        cILocationManager.hookAllMethods("getFromLocation", beforeHook {
            if (FakeLoc.disableGetFromLocation && !FakeLoc.enableAGPS) {
                if(FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "getFromLocation: injected!")
                }
                result = null
            }
        })
        ...
        cILocationManager.hookAllMethods("getFromLocationName", beforeHook {
            if (FakeLoc.disableGetFromLocation && !FakeLoc.enableAGPS) {
                if(FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "getFromLocationName: injected!")
                }
                result = null
            }
        })
        ...
        cILocationManager.hookAllMethods("addTestProvider", beforeHook {
            if (FakeLoc.enable && !FakeLoc.enableAGPS) {
                if(FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "addTestProvider: injected!")
                }
                result = null
            }
        })
        ...
        cILocationManager.hookAllMethods("removeTestProvider", beforeHook {
            if (FakeLoc.enable && !FakeLoc.enableAGPS) {
                if(FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "removeTestProvider: injected!")
                }
                result = null
            }
        })
        ...
        cILocationManager.hookAllMethods("setTestProviderLocation", beforeHook {
            if (FakeLoc.enable && !FakeLoc.enableAGPS) {
                if(FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "setTestProviderLocation: injected!")
                }
                result = null
            }
        })
        ...
        cILocationManager.hookAllMethods("setTestProviderEnabled", beforeHook {
            if (FakeLoc.enable && !FakeLoc.enableAGPS) {
                if(FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "setTestProviderEnabled: injected!")
                }
                result = null
            }
        })
        ...
        if(XposedBridge.hookAllMethods(cILocationManager, "registerGnssStatusCallback", object: XC_MethodHook() {
                override fun afterHookedMethod(param: MethodHookParam?) {
                    ...
                    if(FakeLoc.enableDebugLog) {
                        MiniLog.d(null, "Mini_Xposed", "registerGnssStatusCallback: injected! listener=${callback.javaClass.name}")
                    }
                    ...
                    if (!gnssPushStarted) {
                        ...
                        if (FakeLoc.enableDebugLog) {
                            MiniLog.d(null, "Mini_Xposed", "Started active GNSS push")
                        }
                    }
                    ...
                    if (cIGnssStatusListener.onceHookAllMethod("onSvStatusChanged", beforeHook {
                        ...
                        MiniLog.e(null, "Mini_Xposed", "onSvStatusChanged: unsupported version: $method")
                    }).isEmpty()) {
                        MiniLog.e(null, "Mini_Xposed", "find onSvStatusChanged failed!")
                    }

                    cIGnssStatusListener.onceHookAllMethod("onNmeaReceived", beforeHook {
                        if (FakeLoc.enableDebugLog) {
                            MiniLog.d(null, "Mini_Xposed", "onNmeaReceived")
                        }
                        if (FakeLoc.enableMockGnss) result = null
                    })
                }
            }).isEmpty()) {
            MiniLog.e(null, "Mini_Xposed", "hook registerGnssStatusCallback failed")
        }
        ...
        cILocationManager.hookAllMethods("unregisterGnssStatusCallback", beforeHook {
            if (FakeLoc.enableMockGnss && args.isNotEmpty() && args[0] != null) {
                ...
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "unregisterGnssStatusCallback: removed listener")
                }
            }
        })
        ...
        cILocationManager.hookAllMethods("startGnssBatch", beforeHook {
            if(FakeLoc.enableDebugLog) {
                MiniLog.d(null, "Mini_Xposed", "startGnssBatch: injected!")
            }

            if (FakeLoc.enable && !FakeLoc.enableAGPS && args.size >= 2) {
                val listener = args.filterIsInstance<IInterface>().firstOrNull() ?: run {
                    MiniLog.e(null, "Mini_Xposed", "startGnssBatch: listener is null: $method")
                    return@beforeHook
                }
        ...
        cILocationManager.hookAllMethods("stopGnssBatch", beforeHook {
            if (FakeLoc.enable && !FakeLoc.enableAGPS && args.size >= 2) {
                if(FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "stopGnssBatch: injected!")
                }
            }
        ...
        cILocationManager.hookAllMethods("requestListenerFlush", beforeHook {
            if (FakeLoc.enable && !FakeLoc.enableAGPS && args.size >= 2) {
                if(FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "requestListenerFlush: injected!")
                }

                val listener = args.filterIsInstance<IInterface>().firstOrNull() ?: run {
                    MiniLog.e(null, "Mini_Xposed", "requestListenerFlush: listener is null: $method")
                    return@beforeHook
                }
...
//                    arrayOf("gps", "passive")
//                } else {
//                    MiniLog.e(null, "Mini_Xposed", "getAllProviders: result is not List or Array")
//                    return@afterHook
//                }
//            }
//        })
...
//                    arrayOf("gps", "passive")
//                } else {
//                    MiniLog.e(null, "Mini_Xposed", "getProviders: result is not List or Array")
//                    return@afterHook
//                }
//            }
//        })
...
//            if (FakeLoc.enableDebugLog) {
//                MiniLog.d(null, "Mini_Xposed", "hasProvider: ${args[0]}")
//            }
//
//            if(FakeLoc.enable) {
//                if (args[0] == "gps") {
...
//        })
        ...
        cILocationManager.hookAllMethods("getCurrentLocation", beforeHook {
            ...
            if (FakeLoc.enableDebugLog) {
                MiniLog.d(null, "Mini_Xposed", "getCurrentLocation: injected!")
            }
            ...
            classCallback.onceHookAllMethod("onLocation", beforeHook onLocation@ {
                ...
                if (FakeLoc.enableDebugLog) {
                    MiniLog.d(null, "Mini_Xposed", "onLocation(getCurrentLocation): injected!")
                }
        ...
        cILocationManager.hookAllMethods("sendExtraCommand", beforeHook {
            ...
            if (provider != "kail") {
                if (FakeLoc.enableDebugLog)
                    MiniLog.d(null, "Mini_Xposed", "sendExtraCommand provider: $provider, command: $command, result: $result")
                return@beforeHook
            }
                ...
                object : XC_MethodHook() {
                    override fun beforeHookedMethod(param: MethodHookParam?) {
                        ...
                        if (provider == "kail") {
                            ...
                            if (FakeLoc.enableDebugLog) {
                                 MiniLog.d(null, "Mini_Xposed", "isProviderEnabledForUser provider: $provider, userId: $userId")
                            }
                        }
                    }
                }).isEmpty()
    ...
    private fun hookILocationListener(listener: Any) {
        ...
        if (FakeLoc.enableDebugLog)
            MiniLog.d(null, "Mini_Xposed", "will hook ILocationListener: ${classListener.name}")
        ...
        if(XposedBridge.hookAllMethods(classListener, "onLocationChanged", object: XC_MethodHook() {
                override fun beforeHookedMethod(param: MethodHookParam) {
                    ...
                    when (param.args[0]) {
                        ...
                        else -> MiniLog.e(null, "Mini_Xposed", "onLocationChanged args is not `Location`")
                    }

                    if (FakeLoc.enableDebugLog) {
                        MiniLog.d(null, "Mini_Xposed", "${param.method}: injected! ${param.args[0]}")
                    }
                }
            }).isEmpty()) {
            MiniLog.e(null, "Mini_Xposed", "hook onLocationChanged failed")
...
//
//                    if (FakeLoc.enableDebugLog)
//                        MiniLog.d(null, "Mini_Xposed", "LocationUpdater: callOnLocationChanged: ${locationListeners.size}")
//
//                    callOnLocationChanged()
//                }.onFailure {
//                    MiniLog.e(null, "Mini_Xposed", "LocationUpdater: ${it.message}")
//                }
//            }
//        }
//    }
    ...
    fun callOnLocationChanged() {
        if (FakeLoc.enableDebugLog) {
            MiniLog.d(null, "Mini_Xposed", "==> callOnLocationChanged: ${locationListeners.size}")
        }
        locationListeners.forEach { listenerWithProvider ->
            ...
            if (!called) {
                MiniLog.e(null, "Mini_Xposed", "callOnLocationChanged failed: " + error?.stackTraceToString())
                MiniLog.e(null, "Mini_Xposed", "The listener all methods: " + listener.javaClass.declaredMethods.joinToString { it.name })
            }
        }

        if (FakeLoc.enableDebugLog) {
            MiniLog.d(null, "Mini_Xposed", "==> callOnLocationChanged: end")
        }
    }
    ...
    private fun hookLocationManagerServiceV2(classLoader: ClassLoader) {
        ...
        kotlin.runCatching {
            ...
            fun hookOnTransactForServiceInstance(m: Method) {
                ...
                XposedBridge.hookMethod(m, object : XC_MethodHook() {
                    override fun beforeHookedMethod(param: MethodHookParam?) {
                        ...
                        if (FakeLoc.enableDebugLog) {
                            MiniLog.d(null, "Mini_Xposed", "ILocationManager.Stub: onTransact(code=$code)")
                        }
                    }
                })
            }
            ...
            MiniLog.e(null, "Mini_Xposed", "ILocationManager.Stub not found: ${it.message}")
        }
...
//
//                        XposedBridge.log("[Mini] ILocationManager.Stub.Proxy: c = ${param.thisObject?.javaClass}, m = ${param.method}")
//                    }
//                })
//            }
//        }
