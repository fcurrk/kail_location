...
public final class CameraFrameSource {
        ...
        while (running.get()) {
            ...
            try {
                ...
                if (track < 0 || format == null) {
                    KailLog.e(null, TAG, "no video track in " + videoPath);
                    return;
                }
                ...
                while (running.get()) {
                    ...
                    if (outIdx >= 0) {
                        ...
                        KailLog.i(null, TAG, "format changed: " + codec.getOutputFormat());
                    }
                }
            } catch (Throwable th) {
                KailLog.e(null, TAG, "decodeLoop error", th);
                sleepQuiet(1000);
            } finally {
                if (codec != null) {
    ...
    private void consumeImage(Image img) {
        try {
            ...
            KailLog.e(null, TAG, "consumeImage", th);
        }
    }
