...
object UpdateChecker {
    ...
    private const val OWNER = "fcurrk"
    private const val REPO = "kail_location"
    private const val GITHUB_API = "https://api.github.com/repos/$OWNER/$REPO/releases/latest"
    private const val GITHUB_LATEST_DOWNLOAD = "https://github.com/$OWNER/$REPO/releases/latest/download/MiniLocation.apk"
    private const val APP_KEY = "MiniLocation"
    ...
    private fun buildDownloadUrl(tagName: String): String {
        return "https://github.com/$OWNER/$REPO/releases/download/$tagName/MiniLocation.apk"
    }
        ...
        okHttpClient.newCall(request).enqueue(object : okhttp3.Callback {
            ...
            override fun onResponse(call: okhttp3.Call, response: okhttp3.Response) {
                ...
                if (response.isSuccessful) {
                    ...
                    callback(UpdateInfo(tagName, "", url, "MiniLocation.apk"), null)
                } else {
                    headNext(context, callback, candidates, index + 1)
                }
            }
            ...
            override fun onResponse(call: okhttp3.Call, response: okhttp3.Response) {
                ...
                try {
                    ...
                    if (isNewer(tagName, localVersionName)) {
                        ...
                        callback(UpdateInfo(tagName, body, downloadUrl, "MiniLocation.apk"), null)
                    } else {
